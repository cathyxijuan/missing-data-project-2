...
source("Models_1CR_DF.R") #   redoing n=500  in a different file; redoing n=200 in this file; done at n=200, 500,1000
#source("Models_2CR_DF.R") #  redoing n=200 in the main file ; redone n=1000;500 
...
fitMCAR_0PerMiss_1CR_DF_MI_n200 <- 
...
save(fitMCAR_0PerMiss_1CR_DF_MI_n200, file="fitMCAR_0PerMiss_1CR_DF_MI_n200.RData")
...
fitMCAR_20PerMiss_2VarMiss_1CR_DF_MI_n200 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.20, var.with.missing = 2, sample.nobs = 200)
#fitMCAR_20PerMiss_2VarMiss_1CR_DF_MI_n200[[1]]
#fitMCAR_20PerMiss_2VarMiss_1CR_DF_MI_n200[[2]]
#apply(simplify2array(fitMCAR_20PerMiss_2VarMiss_1CR_DF_MI_n200), 1:2, sd)
save(fitMCAR_20PerMiss_2VarMiss_1CR_DF_MI_n200, file="fitMCAR_20PerMiss_2VarMiss_1CR_DF_MI_n200.RData")


fitMCAR_50PerMiss_2VarMiss_1CR_DF_MI_n200 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.50, var.with.missing = 2, sample.nobs = 200)
save(fitMCAR_50PerMiss_2VarMiss_1CR_DF_MI_n200, file="fitMCAR_50PerMiss_2VarMiss_1CR_DF_MI_n200.RData")
...
fitMCAR_20PerMiss_4VarMiss_1CR_DF_MI_n200 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.20, var.with.missing = 4, sample.nobs = 200)
save(fitMCAR_20PerMiss_4VarMiss_1CR_DF_MI_n200, file="fitMCAR_20PerMiss_4VarMiss_1CR_DF_MI_n200.RData")


fitMCAR_50PerMiss_4VarMiss_1CR_DF_MI_n200 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.50, var.with.missing = 4, sample.nobs = 200)
save(fitMCAR_50PerMiss_4VarMiss_1CR_DF_MI_n200, file="fitMCAR_50PerMiss_4VarMiss_1CR_DF_MI_n200.RData")
