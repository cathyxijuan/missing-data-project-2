...
fitMAR_Strong_20PerMiss_2VarMiss_1CR_DF_n1000000 <-
...
save(fitMAR_Strong_20PerMiss_2VarMiss_1CR_DF_n1000000, file="fitMAR_Strong_20PerMiss_2VarMiss_1CR_DF_n1000000.RData")



fitMAR_Strong_50PerMiss_2VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.50, missing.type = "strong", var.with.missing = 2)

save(fitMAR_Strong_50PerMiss_2VarMiss_1CR_DF_n1000000, file="fitMAR_Strong_50PerMiss_2VarMiss_1CR_DF_n1000000.RData")


fitMAR_Weak_20PerMiss_2VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.20, missing.type = "weak", var.with.missing = 2)


save(fitMAR_Weak_20PerMiss_2VarMiss_1CR_DF_n1000000, file="fitMAR_Weak_20PerMiss_2VarMiss_1CR_DF_n1000000.RData")



fitMAR_Weak_50PerMiss_2VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.50, missing.type = "weak", var.with.missing = 2)

save(fitMAR_Weak_50PerMiss_2VarMiss_1CR_DF_n1000000, file="fitMAR_Weak_50PerMiss_2VarMiss_1CR_DF_n1000000.RData")



#########4 Variables with Missing##############
fitMAR_Strong_20PerMiss_4VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.20, missing.type = "strong", var.with.missing = 2)


save(fitMAR_Strong_20PerMiss_4VarMiss_1CR_DF_n1000000, file="fitMAR_Strong_20PerMiss_4VarMiss_1CR_DF_n1000000.RData")



fitMAR_Strong_50PerMiss_4VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.50, missing.type = "strong", var.with.missing = 4)

save(fitMAR_Strong_50PerMiss_4VarMiss_1CR_DF_n1000000, file="fitMAR_Strong_50PerMiss_4VarMiss_1CR_DF_n1000000.RData")


fitMAR_Weak_20PerMiss_4VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.20, missing.type = "weak",var.with.missing = 4)


save(fitMAR_Weak_20PerMiss_4VarMiss_1CR_DF_n1000000, file="fitMAR_Weak_20PerMiss_4VarMiss_1CR_DF_n1000000.RData")



fitMAR_Weak_50PerMiss_4VarMiss_1CR_DF_n1000000 <-
  fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                     missing.percentage = 0.50, missing.type = "weak",var.with.missing = 4)

save(fitMAR_Weak_50PerMiss_4VarMiss_1CR_DF_n1000000, file="fitMAR_Weak_50PerMiss_4VarMiss_1CR_DF_n1000000.RData")
