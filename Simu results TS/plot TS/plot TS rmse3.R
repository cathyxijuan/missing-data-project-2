...
cond1 <-fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_ts_n200_rmse[row.ind, ]
cond2 <- fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_ts_n500_rmse[row.ind, ]
cond3 <- fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_ts_n1000_rmse[row.ind, ]
cond4 <-fitMAR_Weak_minPat_50PerMiss_6VarMiss_WM_ts_n200_rmse[row.ind, ]
cond5 <- fitMAR_Weak_minPat_50PerMiss_6VarMiss_WM_ts_n500_rmse[row.ind, ]
cond6 <- fitMAR_Weak_minPat_50PerMiss_6VarMiss_WM_ts_n1000_rmse[row.ind, ]
