...
cond.matrix1 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_ts_n200_sd[row.num ,col.num]
cond.matrix2 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_ts_n500_sd[row.num ,col.num]
cond.matrix3 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_ts_n1000_sd[row.num ,col.num]

cond.matrix4 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_ts_n200_sd[row.num ,col.num]
cond.matrix5 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_ts_n500_sd[row.num ,col.num]
cond.matrix6 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_ts_n1000_sd[row.num ,col.num]
cond.num <- 6
row.name <- rep(c("FIML", 
                  "TS  without SSC", 
                  "TS with SSC V1",
...
cond.matrix1 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_ts_n200_sd[row.num ,col.num]
cond.matrix2 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_ts_n500_sd[row.num ,col.num]
cond.matrix3 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_ts_n1000_sd[row.num ,col.num]

cond.matrix4 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_ts_n200_sd[row.num ,col.num]
cond.matrix5 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_ts_n500_sd[row.num ,col.num]
cond.matrix6 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_ts_n1000_sd[row.num ,col.num]
