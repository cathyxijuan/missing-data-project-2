...
fit.ind.matrix.MAR.simu <- function(pop.model.list, fitted.mod, sample.nobs = 1000000, 
  ...
  for(j in 1:simu.num){fit.indices.MAR <-matrix( nrow = 28, ncol = 0)
...
fitMAR_Strong_20PerMiss_2VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.20, missing.type = "strong",
                          sample.nobs = 200,
                          var.with.missing = 2)
save(fitMAR_Strong_20PerMiss_2VarMiss_2CR_SF_n200, file="fitMAR_Strong_20PerMiss_2VarMiss_2CR_SF_n200.RData")


fitMAR_Strong_50PerMiss_2VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.50, missing.type = "strong",
                          sample.nobs = 200,
                          var.with.missing = 2)
save(fitMAR_Strong_50PerMiss_2VarMiss_2CR_SF_n200, file="fitMAR_Strong_50PerMiss_2VarMiss_2CR_SF_n200.RData")


fitMAR_Weak_20PerMiss_2VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.20, missing.type = "weak",
                          sample.nobs = 200,
                          var.with.missing = 2)
save(fitMAR_Weak_20PerMiss_2VarMiss_2CR_SF_n200, file="fitMAR_Weak_20PerMiss_2VarMiss_2CR_SF_n200.RData")


fitMAR_Weak_50PerMiss_2VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.50, missing.type = "weak",
                          sample.nobs = 200,
                          var.with.missing = 2)
save(fitMAR_Weak_50PerMiss_2VarMiss_2CR_SF_n200, file="fitMAR_Weak_50PerMiss_2VarMiss_2CR_SF_n200.RData")
...
fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.20, missing.type = "strong",
                          sample.nobs = 200,
                          var.with.missing = 4)
save(fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_n200, file="fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_n200.RData")


fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.50, missing.type = "strong",
                          sample.nobs = 200,
                          var.with.missing = 4)
save(fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_n200, file="fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_n200.RData")


fitMAR_Weak_20PerMiss_4VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.20, missing.type = "weak",
                          sample.nobs = 200,
                          var.with.missing = 4)
save(fitMAR_Weak_20PerMiss_4VarMiss_2CR_SF_n200, file="fitMAR_Weak_20PerMiss_4VarMiss_2CR_SF_n200.RData")


fitMAR_Weak_50PerMiss_4VarMiss_2CR_SF_n200 <-
  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                          fitted.mod=fitted.mod, 
                          missing.percentage = 0.50, missing.type = "weak",
                          sample.nobs = 200,
                          var.with.missing = 4)
save(fitMAR_Weak_50PerMiss_4VarMiss_2CR_SF_n200, file="fitMAR_Weak_50PerMiss_4VarMiss_2CR_SF_n200.RData")
