...
df20 <-fitMAR_Strong_20PerMiss_4VarMiss_2CR_DF_n1000000["cfi.uncorr.approx", 1:5]
df50 <-fitMAR_Strong_50PerMiss_4VarMiss_2CR_DF_n1000000["cfi.uncorr.approx", 1:5]

sf0 <- fitNoMissingShort_2CR_SF[[2]][1:5, 3]
sf20 <-fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_n1000000["cfi.uncorr.approx", 1:5]
sf50 <-fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_n1000000["cfi.uncorr.approx", 1:5]




df02 <- fitNoMissingShort_2CR_DF[[2]][1:5, 3]
df202 <-fitMAR_Strong_20PerMiss_2VarMiss_2CR_DF_n1000000["cfi.uncorr.approx", 1:5]
df502 <-fitMAR_Strong_50PerMiss_2VarMiss_2CR_DF_n1000000["cfi.uncorr.approx", 1:5]

sf02 <- fitNoMissingShort_2CR_SF[[2]][1:5, 3]
sf202 <-fitMAR_Strong_20PerMiss_2VarMiss_2CR_SF_n1000000["cfi.uncorr.approx", 1:5]
sf502 <-fitMAR_Strong_50PerMiss_2VarMiss_2CR_SF_n1000000["cfi.uncorr.approx", 1:5]
