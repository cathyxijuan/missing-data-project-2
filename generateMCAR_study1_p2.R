...
fitMCAR_20PerMiss_2VarMiss_2CR_DF_n1000000 <- 
  fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.20, var.with.missing = 2)
save(fitMCAR_20PerMiss_2VarMiss_2CR_DF_n1000000, file="fitMCAR_20PerMiss_2VarMiss_2CR_DF_n1000000.RData")



fitMCAR_50PerMiss_2VarMiss_2CR_DF_n1000000 <- 
  fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                      missing.percentage = 0.50, var.with.missing = 2)
save(fitMCAR_50PerMiss_2VarMiss_2CR_DF_n1000000, file="fitMCAR_50PerMiss_2VarMiss_2CR_DF_n1000000.RData")



fitMCAR_20PerMiss_4VarMiss_2CR_DF_n1000000 <- 
  fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                      missing.percentage = 0.20, var.with.missing = 4)
save(fitMCAR_20PerMiss_4VarMiss_2CR_DF_n1000000, file="fitMCAR_20PerMiss_4VarMiss_2CR_DF_n1000000.RData")



fitMCAR_50PerMiss_4VarMiss_2CR_DF_n1000000 <- 
  fit.ind.matrix.MCAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
