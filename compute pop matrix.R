...
fitNoMissing_1CR_SF_new_RMSEA <- matrix(rep(as.vector(fitNoMissing_1CR_SF_new[1,], mode = "numeric"), 8), 
                                        nrow=8,
                                        byrow=T)

fitNoMissing_1CR_SF_new_CFI <- matrix(rep(as.vector(fitNoMissing_1CR_SF_new[2,], mode = "numeric"), 8), 
                                      nrow=8, 
                                      byrow=T)
fitNoMissing_1CR_SF_matrix <- rbind(fitNoMissing_1CR_SF_new_RMSEA, fitNoMissing_1CR_SF_new_CFI)
...
fitNoMissing_1CR_DF_new_RMSEA <- matrix(rep(as.vector(fitNoMissing_1CR_DF_new[1,], mode = "numeric"), 8), 
                                        nrow=8,
                                        byrow=T)

fitNoMissing_1CR_DF_new_CFI <- matrix(rep(as.vector(fitNoMissing_1CR_DF_new[2,], mode = "numeric"), 8), 
                                      nrow=8, 
                                      byrow=T)
fitNoMissing_1CR_DF_matrix <- rbind(fitNoMissing_1CR_DF_new_RMSEA, fitNoMissing_1CR_DF_new_CFI)
...
fitNoMissing_2CR_DF_new_RMSEA <- matrix(rep(as.vector(fitNoMissing_2CR_DF_new[1,], mode = "numeric"), 8), 
                                        nrow=8,
                                        byrow=T)

fitNoMissing_2CR_DF_new_CFI <- matrix(rep(as.vector(fitNoMissing_2CR_DF_new[2,], mode = "numeric"), 8), 
                                      nrow=8, 
                                      byrow=T)
fitNoMissing_2CR_DF_matrix <- rbind(fitNoMissing_2CR_DF_new_RMSEA, fitNoMissing_2CR_DF_new_CFI)
...
fitNoMissing_WM_new_RMSEA <- matrix(rep(as.vector(fitNoMissing_WM_new[1,], mode = "numeric"), 8), 
                                    nrow=8,
                                    byrow=T)

fitNoMissing_WM_new_CFI <- matrix(rep(as.vector(fitNoMissing_WM_new[2,], mode = "numeric"), 8), 
                                  nrow=8, 
                                  byrow=T)
fitNoMissing_WM_matrix <- rbind(fitNoMissing_WM_new_RMSEA, fitNoMissing_WM_new_CFI)
