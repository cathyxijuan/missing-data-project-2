...
fimlc.nam <- row.names(fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n200_rmse)
...
library(reshape2)
library(ggsci)
###Study 1 not in paper

cond1 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n200_rmse[fimlc.nam, ]
cond2 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n500_rmse[fimlc.nam, ]
cond3 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n1000_rmse[fimlc.nam, ]
...
cond7 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n200_rmse[fimlc.nam, ]
cond8 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n500_rmse[fimlc.nam, ]
cond9 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n1000_rmse[fimlc.nam, ]

cond10 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_ts_n200_rmse[ts.nam, ]
cond11 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_ts_n500_rmse[ts.nam, ]
cond12<- fitMCAR_50PerMiss_4VarMiss_2CR_SF_ts_n1000_rmse[ts.nam, ]
cond13<- fitMAR_Weak_50PerMiss_4VarMiss_2CR_SF_ts_n200_rmse[ts.nam, ]
cond14<- fitMAR_Weak_50PerMiss_4VarMiss_2CR_SF_ts_n500_rmse[ts.nam, ]
cond15<- fitMAR_Weak_50PerMiss_4VarMiss_2CR_SF_ts_n1000_rmse[ts.nam, ]
cond16<- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_ts_n200_rmse[ts.nam, ]
cond17<- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_ts_n500_rmse[ts.nam, ]
cond18<- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_ts_n1000_rmse[ts.nam, ]
...
ggplot(rmsea_long, aes(x=Size_of_CR, y=RMSEA, group=Version)) + 
  ...
  xlab("Size of Correlated Residual (Degree of Misfit)") +  ylab("RMSE in RMSEA")+
  scale_y_continuous(limits = c(0, 0.58))+  theme_bw() + 
...
ggplot(cfi_long, aes(x=Size_of_CR, y=CFI, group=Version)) + 
  ...
  geom_point(aes(color=Version, shape = Version), size=2) +
  facet_grid(Sample_Size~Col_Var_Missing) +
  xlab("Size of Correlated Residual (Degree of Misfit)") +  ylab("RMSE in CFI")+
  scale_y_continuous(limits = c(0, 0.35))+theme_bw() +   
  scale_shape_manual(values=shape.pat)+
  scale_linetype_manual(values=line.pat)+ scale_color_manual(values=color.pat)
...
cond1 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_fimlc_n200_rmse[fimlc.nam, ]
cond2 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_fimlc_n500_rmse[fimlc.nam, ]
cond3 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_fimlc_n1000_rmse[fimlc.nam, ]
cond4 <- fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_fimlc_n200_rmse[fimlc.nam, ]
cond5 <- fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_fimlc_n500_rmse[fimlc.nam, ]
cond6 <- fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_fimlc_n1000_rmse[fimlc.nam, ]
cond7 <- fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_fimlc_n200_rmse[fimlc.nam, ]
cond8 <- fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_fimlc_n500_rmse[fimlc.nam, ]
cond9 <- fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_fimlc_n1000_rmse[fimlc.nam, ]

cond10 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_ts_n200_rmse[ts.nam, ]
cond11 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_ts_n500_rmse[ts.nam, ]
cond12<- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_ts_n1000_rmse[ts.nam, ]
cond13<- fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_ts_n200_rmse[ts.nam, ]
cond14<- fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_ts_n500_rmse[ts.nam, ]
cond15<- fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_ts_n1000_rmse[ts.nam, ]
cond16<- fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_ts_n200_rmse[ts.nam, ]
cond17<- fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_ts_n500_rmse[ts.nam, ]
cond18<- fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_ts_n1000_rmse[ts.nam, ]
...
ggplot(rmsea_long, aes(x=Size_of_CR, y=RMSEA, group=Version)) + 
  ...
  xlab("Size of Factor Correlation (Degree of Misfit)") +  ylab("RMSE in RMSEA")+
