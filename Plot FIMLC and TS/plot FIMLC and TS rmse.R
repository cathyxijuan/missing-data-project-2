...
combine.nam <- c("rmsea.fiml", "rmsea.cor.obs_unstr","rmsea.cor.unstr",
                 "cfi.fiml", "cfi.cor.obs_unstr", "cfi.cor.unstr")
...
cond1 <- fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_fimlc_n200_rmse[fimlc.nam, ]
cond2 <- fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_fimlc_n500_rmse[fimlc.nam, ]
cond3 <- fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_fimlc_n1000_rmse[fimlc.nam, ]
cond4 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n200_rmse[fimlc.nam, ]
cond5 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n500_rmse[fimlc.nam, ]
cond6 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_fimlc_n1000_rmse[fimlc.nam, ]

cond7 <- fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_ts_n200_rmse[ts.nam, ]
cond8 <- fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_ts_n500_rmse[ts.nam, ]
cond9 <- fitMAR_Strong_20PerMiss_4VarMiss_2CR_SF_ts_n1000_rmse[ts.nam, ]
cond10 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_ts_n200_rmse[ts.nam, ]
cond11 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_ts_n500_rmse[ts.nam, ]
cond12 <- fitMAR_Strong_50PerMiss_4VarMiss_2CR_SF_ts_n1000_rmse[ts.nam, ]
...
cond.num <- 6
row.name <- rep(c("FIML","FIML-C with SSC V6", "TS with SSC V2"),cond.num)
...
ggplot(rmsea_long, aes(x=Size_of_CR, y=RMSEA, group=Version)) + 
  ...
  scale_y_continuous(limits = c(0, 0.08))+ scale_color_d3()+
...
combine.nam <- c("rmsea.fiml", "rmsea.cor.obs_unstr","rmsea.cor.unstr",
                 "cfi.fiml", "cfi.cor.obs_unstr", "cfi.cor.unstr")
cond1 <- fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_fimlc_n200_rmse[fimlc.nam, ]
cond2 <- fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_fimlc_n500_rmse[fimlc.nam, ]
cond3 <- fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_fimlc_n1000_rmse[fimlc.nam, ]
cond4 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_fimlc_n200_rmse[fimlc.nam, ]
cond5 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_fimlc_n500_rmse[fimlc.nam, ]
cond6 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_fimlc_n1000_rmse[fimlc.nam, ]

cond7 <- fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_ts_n200_rmse[ts.nam, ]
cond8 <- fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_ts_n500_rmse[ts.nam, ]
cond9 <- fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_ts_n1000_rmse[ts.nam, ]
...
ggplot(rmsea_long, aes(x=Size_of_CR, y=RMSEA, group=Version)) + 
  ...
  scale_y_continuous(limits = c(0, 0.15))+ scale_color_d3()+
  theme_bw() + theme(legend.position = "none")
...
ggplot(cfi_long, aes(x=Size_of_CR, y=CFI, group=Version)) + 
  ...
  facet_grid(Sample_Size~Var_Missing) +scale_x_reverse()+
  xlab("Size of Factor Correlation (Degree of Misfit)") +
  scale_y_continuous(limits = c(0, 0.25))+ scale_color_d3()+
  theme_bw()  
