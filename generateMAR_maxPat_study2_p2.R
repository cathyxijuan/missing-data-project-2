...
fitMAR_Strong_maxPat_20PerMiss_2VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod,
                                                                                  missing.percentage = 0.20, missing.type = "strong",
                                                                                  var.with.missing = 2), 8)
save(fitMAR_Strong_maxPat_20PerMiss_2VarMiss_WM_n1000000, file="fitMAR_Strong_maxPat_20PerMiss_2VarMiss_WM_n1000000.RData")
...
fitMAR_Weak_maxPat_20PerMiss_2VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, 
                                                                                fitted.mod=fitted.mod, 
                                                                                missing.percentage = 0.20, 
                                                                                missing.type = "weak",
                                                                                var.with.missing = 2), 8)

save(fitMAR_Weak_maxPat_20PerMiss_2VarMiss_WM_n1000000 , file="fitMAR_Weak_maxPat_20PerMiss_2VarMiss_WM_n1000000.RData")


fitMAR_Weak_maxPat_50PerMiss_2VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                                                                                missing.percentage = 0.50, missing.type = "weak",
                                                                                var.with.missing = 2), 8)


save(fitMAR_Weak_maxPat_50PerMiss_2VarMiss_WM_n1000000 , file="fitMAR_Weak_maxPat_50PerMiss_2VarMiss_WM_n1000000.RData")
...
fitMAR_Strong_maxPat_20PerMiss_4VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                                                                                   missing.percentage = 0.20, missing.type = "strong",
                                                                                   var.with.missing = 4), 8)
save(fitMAR_Strong_maxPat_20PerMiss_4VarMiss_WM_n1000000 , file="fitMAR_maxPat_Strong_20PerMiss_4VarMiss_WM_n1000000.RData")
fitMAR_Strong_maxPat_50PerMiss_4VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod,
                                                                                  missing.percentage = 0.50, missing.type = "strong",
                                                                                  var.with.missing = 4), 8)
save(fitMAR_Strong_maxPat_50PerMiss_4VarMiss_WM_n1000000, file="fitMAR_Strong_maxPat_50PerMiss_4VarMiss_WM_n1000000.RData")



fitMAR_Weak_maxPat_20PerMiss_4VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                                                                                missing.percentage = 0.20, missing.type = "weak",
                                                                                var.with.missing = 4), 8)

save(fitMAR_Weak_maxPat_20PerMiss_4VarMiss_WM_n1000000 , file="fitMAR_Weak_maxPat_20PerMiss_4VarMiss_WM_n1000000.RData")


fitMAR_Weak_maxPat_50PerMiss_4VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                                                                                missing.percentage = 0.50, missing.type = "weak",
                                                                                var.with.missing = 4), 8)

save(fitMAR_Weak_maxPat_50PerMiss_4VarMiss_WM_n1000000, file="fitMAR_Weak_maxPat_50PerMiss_4VarMiss_WM_n1000000.RData")
...
fitMAR_Strong_maxPat_20PerMiss_6VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod,
                                                                                  missing.percentage = 0.20, missing.type = "strong",
                                                                                  var.with.missing = 6), 8)
save(fitMAR_Strong_maxPat_20PerMiss_6VarMiss_WM_n1000000 , file="fitMAR_Strong_maxPat_20PerMiss_6VarMiss_WM_n1000000.RData")
fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod,
                                                                                  missing.percentage = 0.50, missing.type = "strong",
                                                                                  var.with.missing = 6), 8)
save(fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_n1000000, file="fitMAR_Strong_maxPat_50PerMiss_6VarMiss_WM_n1000000.RData")



fitMAR_Weak_maxPat_20PerMiss_6VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                                                                                missing.percentage = 0.20, missing.type = "weak",
                                                                                var.with.missing = 6), 8)

save(fitMAR_Weak_maxPat_20PerMiss_6VarMiss_WM_n1000000 , file="fitMAR_Weak_maxPat_20PerMiss_6VarMiss_WM_n1000000.RData")


fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_n1000000 <-   round(fit.ind.matrix.MAR(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                                                                                missing.percentage = 0.50, missing.type = "weak",
                                                                                var.with.missing = 6), 8)

save(fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_n1000000, file="fitMAR_Weak_maxPat_50PerMiss_6VarMiss_WM_n1000000.RData")
