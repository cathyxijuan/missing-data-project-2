...
df <- lavInspect(fit.Mplus.obs, "fit")["df"]
fit.Mplus.obs@Fit@test$satorra.bentler$scaling.factor #0.9655038


fit.Mplus.exp<-cfa(fitted.mod,data=data1,mimic="MPLUS",estimator="MLM", information="expected")
fit.Mplus.exp@Fit@test$satorra.bentler$scaling.factor #0.9655038
...
df <- lavInspect(fit.EQS.obs, "fit")["df"]
fit.EQS.obs@Fit@test$satorra.bentler$scaling.factor #0.3823781


fit.EQS.exp<-cfa(fitted.mod,data=data1,mimic="EQS",estimator="MLM", information="expected")
fit.EQS.exp@Fit@test$satorra.bentler$scaling.factor #1.037378
...
c.EQS.obs  #-0.1431069  produced exactly 
...
c.EQS.exp  #1.098429  produced exactly 



c.software <- c(0.9655038, 0.9655038, 0.3823781,1.037378) #correction value produced by Lavaan 
