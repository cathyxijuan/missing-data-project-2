...
############ 
fit.ind.matrix.MCAR.mi <- function(pop.model.list, 
                                   fitted.mod, sample.nobs = 1000000,  
                                   missing.percentage, missing.type, 
                                   var.with.missing, num.of.imp = 20){
...
fitMCAR_MinPat_20PerMiss_2VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,fitted.mod=fitted.mod,
                      missing.percentage = 0.20, missing.type = "min", sample.nobs = 1000000,
                      var.with.missing = 2, num.of.imp = 1)
...
fitMCAR_MinPat_50PerMiss_2VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
...
fitMCAR_MaxPat_20PerMiss_2VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
                            missing.percentage = 0.20, missing.type = "max", var.with.missing = 2, num.of.imp = 1)
...
fitMCAR_MaxPat_50PerMiss_2VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
                            missing.percentage = 0.50, missing.type = "max",  var.with.missing = 2, num.of.imp = 1)
...
fitMCAR_MinPat_20PerMiss_4VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
                            missing.percentage = 0.20, missing.type = "min" ,var.with.missing = 4, num.of.imp = 1)
...
fitMCAR_MinPat_50PerMiss_4VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
                            missing.percentage = 0.50, missing.type = "min",var.with.missing = 4, num.of.imp = 1)
...
fitMCAR_MaxPat_20PerMiss_4VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
                            missing.percentage = 0.20, missing.type = "max" ,var.with.missing = 4, num.of.imp = 1)
...
fitMCAR_MaxPat_50PerMiss_4VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
                            missing.percentage = 0.50, missing.type = "max" ,var.with.missing = 4, num.of.imp = 1)
...
fitMCAR_MinPat_20PerMiss_6VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs =1000000,
                            missing.percentage = 0.20, missing.type = "min", var.with.missing = 6, num.of.imp = 1)
save( fitMCAR_MinPat_20PerMiss_6VarMiss_WM_MI_n1000000, file="fitMCAR_MinPat_20PerMiss_6VarMiss_WM_n1000000.RData")

fitMCAR_MinPat_50PerMiss_6VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs =1000000,
                            missing.percentage = 0.50, missing.type = "min", var.with.missing = 6, num.of.imp = 1)
...
fitMCAR_MaxPat_20PerMiss_6VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs =1000000,
                            missing.percentage = 0.20, missing.type = "Max", var.with.missing = 6, num.of.imp = 1)
...
fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_MI_n1000000 <-
  fit.ind.matrix.MCAR.mi(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs =1000000,
                            missing.percentage = 0.50, missing.type = "Max", var.with.missing = 6, num.of.imp = 1)
