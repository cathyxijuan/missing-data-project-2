...
cond1 <-fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_fimlc_n200_rmse[row.ind, ]
cond2 <- fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_fimlc_n500_rmse[row.ind, ]
cond3 <- fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_fimlc_n1000_rmse[row.ind, ]
cond4 <-fitMAR_Weak_minPat_50PerMiss_6VarMiss_WM_fimlc_n200_rmse[row.ind, ]
cond5 <- fitMAR_Weak_minPat_50PerMiss_6VarMiss_WM_fimlc_n500_rmse[row.ind, ]
cond6 <- fitMAR_Weak_minPat_50PerMiss_6VarMiss_WM_fimlc_n1000_rmse[row.ind, ]
...
ggplot(cfi_long, aes(x=Size_of_CR, y=CFI, group=Version)) + 
  ...
  scale_x_reverse()+scale_shape_manual(values=c(3,4,5, 6, 8))+
  scale_linetype_manual(values=c(3,4,5, 6, 8))
