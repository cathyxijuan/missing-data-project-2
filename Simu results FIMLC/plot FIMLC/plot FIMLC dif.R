...
cond.matrix1 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_fimlc_n200_dif[row.num ,col.num]
cond.matrix2 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_fimlc_n500_dif[row.num ,col.num]
cond.matrix3 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_fimlc_n1000_dif[row.num ,col.num]
cond.matrix4 <- fitMCAR_20PerMiss_4VarMiss_2CR_SF_fimlc_n1000000_dif[row.num ,col.num]
cond.matrix5 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n200_dif[row.num ,col.num]
cond.matrix6 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n500_dif[row.num ,col.num]
cond.matrix7 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n1000_dif[row.num ,col.num]
cond.matrix8 <- fitMCAR_50PerMiss_4VarMiss_2CR_SF_fimlc_n1000000_dif[row.num ,col.num]
...
cond.matrix1 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_fimlc_n200_dif[row.num ,col.num]
cond.matrix2 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_fimlc_n500_dif[row.num ,col.num]
cond.matrix3 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_fimlc_n1000_dif[row.num ,col.num]
cond.matrix4 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_fimlc_n1000000_dif[row.num ,col.num]
cond.matrix5 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_fimlc_n200_dif[row.num ,col.num]
cond.matrix6 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_fimlc_n500_dif[row.num ,col.num]
cond.matrix7 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_fimlc_n1000_dif[row.num ,col.num]
cond.matrix8 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_fimlc_n1000000_dif[row.num ,col.num]
