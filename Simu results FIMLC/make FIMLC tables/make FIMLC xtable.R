...
fimlc.s2.table(fitMCAR_MinPat_50PerMiss_2VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, minimum pattern, two variables with missing data with 50\\% missing in each.", w.in.num = 100,         bold.note=" ")
...
fimlc.s2.table(fitMCAR_MinPat_20PerMiss_4VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, minimum pattern, four variables with missing data with 20\\% missing in each.", w.in.num = 100,         bold.note=" ")
...
fimlc.s2.table(fitMCAR_MinPat_50PerMiss_4VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, minimum pattern, four variables with missing data with 50\\% missing in each.", w.in.num = 100,         bold.note=" ")
...
fimlc.s2.table(fitMCAR_MaxPat_20PerMiss_2VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, maximum pattern, two variables with missing data with 20\\% missing in each.", w.in.num = 100,         bold.note=" ")
...
fimlc.s2.table(fitMCAR_MaxPat_50PerMiss_2VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, maximum pattern, two variables with missing data with 50\\% missing in each.", w.in.num = 100,         bold.note=" ")
...
fimlc.s2.table(fitMCAR_MaxPat_20PerMiss_4VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, maximum pattern, four variables with missing data with 20\\% missing in each.", w.in.num = 100, bold.note=" ")
...
fimlc.s2.table(fitMCAR_MaxPat_50PerMiss_4VarMiss_WM_fimlc_n200_mean, 
               ...
               caption.before = "Average Estimate of", 
               caption.after = "MCAR, maximum pattern, four variables with missing data with 50\\% missing in each.", w.in.num = 100, bold.note=" ")
