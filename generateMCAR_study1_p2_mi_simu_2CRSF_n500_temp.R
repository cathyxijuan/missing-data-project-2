...
source("functions.R")
source("Models_2CR_SF.R") #   redoing:n=1000; redoing n=200 at a different file; redoing n=500 at this file, done at n=200 n=500, 1000
...
fitMCAR_0PerMiss_2CR_SF_MI_n500 <- 
...
save(fitMCAR_0PerMiss_2CR_SF_MI_n500, file="fitMCAR_0PerMiss_2CR_SF_MI_n500.RData")
...
fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.20, var.with.missing = 2, sample.nobs = 500)
#fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500[[1]]
#fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500[[2]]
#apply(simplify2array(fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500), 1:2, sd)
save(fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500, file="fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500.RData")


fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n500 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.50, var.with.missing = 2, sample.nobs = 500)
save(fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n500, file="fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n500.RData")
...
fitMCAR_20PerMiss_4VarMiss_2CR_SF_MI_n500 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.20, var.with.missing = 4, sample.nobs = 500)
save(fitMCAR_20PerMiss_4VarMiss_2CR_SF_MI_n500, file="fitMCAR_20PerMiss_4VarMiss_2CR_SF_MI_n500.RData")


fitMCAR_50PerMiss_4VarMiss_2CR_SF_MI_n500 <- 
  fit.ind.matrix.MCAR.simu(pop.model.list=pop.mod, fitted.mod=fitted.mod, 
                           missing.percentage = 0.50, var.with.missing = 4, sample.nobs = 500)
save(fitMCAR_50PerMiss_4VarMiss_2CR_SF_MI_n500, file="fitMCAR_50PerMiss_4VarMiss_2CR_SF_MI_n500.RData")



apply(simplify2array(fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n500), 1:2, mean)-apply(simplify2array(fitMCAR_0PerMiss_2CR_SF_MI_n500), 1:2, mean)
fitNoMissing_2CR_SF_new
apply(simplify2array(fitMCAR_0PerMiss_2CR_SF_MI_n500), 1:2, mean)
apply(simplify2array(fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n500), 1:2, mean)[1:4,]-rbind(fitNoMissing_2CR_SF_new,fitNoMissing_2CR_SF_new)
