source("/Volumes/SP PHD U3/missing-data-project-2/Simu resulMI MI/compute MI means.R")
library(dplyr)
library(ggplot2)
library(reshape2)
library(ggsci)
...
cond.matrix1 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n200_mean[row.num ,col.num]
cond.matrix2 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n500_mean[row.num ,col.num]
cond.matrix3 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n1000_mean[row.num ,col.num]
cond.matrix4 <- fitMCAR_20PerMiss_2VarMiss_2CR_SF_MI_n1000000_mean[row.num ,col.num]
cond.matrix5 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n200_mean[row.num ,col.num]
cond.matrix6 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n500_mean[row.num ,col.num]
cond.matrix7 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n1000_mean[row.num ,col.num]
cond.matrix8 <- fitMCAR_50PerMiss_2VarMiss_2CR_SF_MI_n1000000_mean[row.num ,col.num]
...
Sample_Size <- rep(rep(rep(c("n= 200", "n= 500", "n=1000", "n=1000000"), each=ver.num),2),5)
length(Sample_Size)
rmsea_long$Sample_Size <- as.factor(Sample_Size)

Percentage_of_Missing <- rep(rep(c("20% Missing","50% Missing"), each=ver.num*sample.num),5)
...
ggplot(rmsea_long, aes(x=Size_of_CR, y=RMSEA, group=Version)) + 
  ...
  scale_y_continuous(limit = c(0, 0.20))+ 
  theme_bw() 
...
cond.matrix1 <- fitMCAR_MaxPat_50PerMiss_2VarMiss_WM_MI_n200_mean[row.num,col.num]
cond.matrix2 <- fitMCAR_MaxPat_50PerMiss_2VarMiss_WM_MI_n500_mean[row.num ,col.num]
cond.matrix3 <- fitMCAR_MaxPat_50PerMiss_2VarMiss_WM_MI_n1000_mean[row.num ,col.num]
cond.matrix4 <- fitMCAR_MaxPat_50PerMiss_2VarMiss_WM_MI_n1000000_mean[row.num ,col.num]
cond.matrix5 <- fitMCAR_MaxPat_50PerMiss_4VarMiss_WM_MI_n200_mean[row.num ,col.num]
cond.matrix6 <- fitMCAR_MaxPat_50PerMiss_4VarMiss_WM_MI_n500_mean[row.num ,col.num]
cond.matrix7 <- fitMCAR_MaxPat_50PerMiss_4VarMiss_WM_MI_n1000_mean[row.num ,col.num]
cond.matrix8 <- fitMCAR_MaxPat_50PerMiss_4VarMiss_WM_MI_n1000000_mean[row.num ,col.num]
cond.matrix9 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_MI_n200_mean[row.num ,col.num]
cond.matrix10 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_MI_n500_mean[row.num ,col.num]
cond.matrix11 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_MI_n1000_mean[row.num ,col.num]
cond.matrix12 <- fitMCAR_MaxPat_50PerMiss_6VarMiss_WM_MI_n1000000_mean[row.num ,col.num]
