...
fitMAR_Strong_minPat_20PerMiss_2VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                            fitted.mod=fitted.mod, 
                                                                            missing.percentage = 0.20, 
                                                                            sample.nobs=1000,
                                                                            missing.type = "strong",
                                                                            var.with.missing = 2)
save(fitMAR_Strong_minPat_20PerMiss_2VarMiss_WM_MI_n1000, file="fitMAR_Strong_minPat_20PerMiss_2VarMiss_WM_MI_n1000.RData")





fitMAR_Strong_minPat_50PerMiss_2VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                               fitted.mod=fitted.mod, 
...
save(fitMAR_Strong_minPat_50PerMiss_2VarMiss_WM_MI_n1000 , file="fitMAR_Strong_minPat_50PerMiss_2VarMiss_WM_MI_n1000.RData")



fitMAR_Weak_minPat_20PerMiss_2VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                             fitted.mod=fitted.mod, 
                                                                             missing.percentage = 0.20, 
                                                                             sample.nobs=1000,
                                                                             missing.type = "weak",
...
save(fitMAR_Weak_minPat_20PerMiss_2VarMiss_WM_MI_n1000, file="fitMAR_Weak_minPat_20PerMiss_2VarMiss_WM_MI_n1000.RData")

fitMAR_Weak_minPat_50PerMiss_2VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                             fitted.mod=fitted.mod, 
                                                                             missing.percentage = 0.50, 
                                                                             sample.nobs=1000,
                                                                             missing.type = "weak",
...
save(fitMAR_Weak_minPat_50PerMiss_2VarMiss_WM_MI_n1000 , file="fitMAR_Weak_minPat_50PerMiss_2VarMiss_WM_MI_n1000.RData")
...
fitMAR_Strong_minPat_20PerMiss_4VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                               fitted.mod=fitted.mod, 
                                                                               missing.percentage = 0.20, 
                                                                               sample.nobs=1000,
                                                                               missing.type = "strong",
...
save(fitMAR_Strong_minPat_20PerMiss_4VarMiss_WM_MI_n1000, file="fitMAR_Strong_minPat_20PerMiss_4VarMiss_WM_MI_n1000.RData")

fitMAR_Strong_minPat_50PerMiss_4VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                               fitted.mod=fitted.mod, 
                                                                               missing.percentage = 0.50, 
                                                                               sample.nobs=1000,
                                                                               missing.type = "strong",
...
save(fitMAR_Strong_minPat_50PerMiss_4VarMiss_WM_MI_n1000 , file="fitMAR_Strong_minPat_50PerMiss_4VarMiss_WM_MI_n1000.RData")



fitMAR_Weak_minPat_20PerMiss_4VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                             fitted.mod=fitted.mod, 
                                                                             missing.percentage = 0.20, 
                                                                             sample.nobs=1000,
                                                                             missing.type = "weak",
...
save(fitMAR_Weak_minPat_20PerMiss_4VarMiss_WM_MI_n1000, file="fitMAR_Weak_minPat_20PerMiss_4VarMiss_WM_MI_n1000.RData")

fitMAR_Weak_minPat_50PerMiss_4VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                             fitted.mod=fitted.mod, 
                                                                             missing.percentage = 0.50, 
                                                                             sample.nobs=1000,
                                                                             missing.type = "weak",
...
save(fitMAR_Weak_minPat_50PerMiss_4VarMiss_WM_MI_n1000 , file="fitMAR_Weak_minPat_50PerMiss_4VarMiss_WM_MI_n1000.RData")



############6 variables with missing##############

fitMAR_Strong_minPat_20PerMiss_6VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                               fitted.mod=fitted.mod, 
                                                                               missing.percentage = 0.20, 
                                                                               sample.nobs=1000,
                                                                               missing.type = "strong",
...
save(fitMAR_Strong_minPat_50PerMiss_6VarMiss_WM_MI_n1000 , file="fitMAR_Strong_minPat_50PerMiss_6VarMiss_WM_MI_n1000.RData")



fitMAR_Weak_minPat_20PerMiss_6VarMiss_WM_MI_n1000 <-  fit.ind.matrix.MAR.simu(pop.model.list=pop.mod, 
                                                                             fitted.mod=fitted.mod, 
                                                                             missing.percentage = 0.20, 
                                                                             sample.nobs=1000,
                                                                             missing.type = "weak",
