library(lavaan)
source("functions.R")
#source("Models_2CR_SF.R") #done n=200, 500,  n=1000
#source("Models_1CR_SF.R") #done at n=200, 500, doing n=1000
source("Models_1CR_DF.R") # done n=200, 500, DOING N=1000
#source("Models_2CR_DF.R") #done n=200 n=500, 1000
