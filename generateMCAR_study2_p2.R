...
#save(fitMCAR_MaxPat_20PerMiss_2VarMiss_WM_n100000, file="fitMCAR_MaxPat_20PerMiss_2VarMiss_WM_n100000.RData")
...
#save(fitMCAR_MinPat_20PerMiss_4VarMiss_WM_n100000, file="fitMCAR_MinPat_20PerMiss_4VarMiss_WM_n100000.RData")
...
#save(fitMCAR_MinPat_50PerMiss_4VarMiss_WM_n100000, file="fitMCAR_MinPat_50PerMiss_4VarMiss_WM_n100000.RData")


fitMCAR_MaxPat_20PerMiss_4VarMiss_WM_n100000 <-
  round(fit.ind.matrix.MCAR(pop.model.list=pop.mod,
                            fitted.mod=fitted.mod,sample.nobs = 1000000,
